...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<td width="70%">
	<input  type="text" name="sno"  id='snoid'  size="30"  />
	</td>
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<td width="70%">
	<input  type="text" name="sname"  id='snameid'  size="30"  />
	</td>
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<td width="70%">
<input  type="text" name="lianxidianhua"  id='lianxidianhuaid'  size="30"  />
	</td>
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<td width="70%">
<input  type="text" name="banjimingchen"  id='banjimingchenid'  size="30"  />
	</td>
